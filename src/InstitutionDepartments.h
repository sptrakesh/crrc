...
namespace crrc
{
  class InstitutionDepartments : public Cutelyst::Controller
  {
    Q_OBJECT
  public:
    explicit InstitutionDepartments( QObject* parent = nullptr ) : Controller( parent ) {}
    ~InstitutionDepartments() = default;
